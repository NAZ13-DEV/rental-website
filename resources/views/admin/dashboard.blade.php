    ...
    <div class="main-content">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="overflow-hidden flex-grow-1">
                                                    <p class="mb-0 text-uppercase fw-medium text-muted text-truncate"> Total Earnings</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <h5 class="mb-0 text-success fs-14">
                                                        <i class="align-middle ri-arrow-right-up-line fs-13"></i> +16.24 %
                                                    </h5>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="overflow-hidden flex-grow-1">
                                                 <p class="mb-0 text-uppercase fw-medium text-muted text-truncate">Orders</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <h5 class="mb-0 text-danger fs-14">
                                                        <i class="align-middle ri-arrow-right-down-line fs-13"></i> -3.57 %
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="mt-4 d-flex align-items-end justify-content-between">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <h5 class="mb-0 text-success fs-14">
                                                        <i class="align-middle ri-arrow-right-up-line fs-13"></i> +29.08 %
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="mt-4 d-flex align-items-end justify-content-between">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2">
                                                                        <img src="/default/assets/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle" />
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2">
                                                                        <img src="/default/assets/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle" />
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2">
                                                                        <img src="/default/assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle" />
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2">
                                                                        <img src="/default/assets/images/users/avatar-4.jpg.png" alt="" class="avatar-xs rounded-circle" />
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2">
                                                                        <img src="/default/assets/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle" />
                                                                    </div>
                                ...
                                <div class="p-0 card-body">
                                    ...
                                    <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                                        <div class="acitivity-timeline acitivity-main">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="gap-2 p-2 mb-2 border border-dashed d-inline-flex">
                                                        <a href="apps-ecommerce-product-details.html" class="p-1 rounded bg-light">
                                                            <img src="/default/assets/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                                        </a>
                                                        <a href="apps-ecommerce-product-details.html" class="p-1 rounded bg-light">
                                                            <img src="/default/assets/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                                        </a>
                                                        <a href="apps-ecommerce-product-details.html" class="p-1 rounded bg-light">
                                                            <img src="/default/assets/images/products/img-10.png" alt="" class="img-fluid d-block" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="py-3 acitivity-item d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="/default/assets/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="acitivity-item d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="/default/assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0 avatar-sm">
                                                                    <div class="rounded avatar-title bg-light">
                                                                        <img src="/default/assets/images/companies/img-1.png" alt="" height="30">
                                                                    </div>
                                                                </div>
                                                                <div class="flex-grow-1 ms-3">
                                                                    <div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="border border-dashed shadow-none card">
                                                        <div class="card-body">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/default/assets/images/users/avatar-3.jpg" alt="" class="rounded avatar-sm">
                                                                </div>
                                                                <div class="flex-grow-1 ms-3">
                                                                    <div>
                                                    ...
                                                    <div class="border border-dashed shadow-none card">
                                                        <div class="card-body">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0 avatar-sm">
                                                                    <div class="rounded avatar-title bg-light">
                                                                        <img src="/default/assets/images/companies/img-8.png" alt="" height="30">
                                                                    </div>
                                                                </div>
                                                                <div class="flex-grow-1 ms-3">
                                                                    <div>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="border border-dashed shadow-none card">
                                                        <div class="card-body">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0">
                                                                    <img src="/default/assets/images/users/avatar-2.jpg" alt="" class="rounded avatar-sm">
                                                                </div>
                                                                <div class="flex-grow-1 ms-3">
                                                                    <div>
                                    ...
                                    <div class="mx-4 mt-3 mb-0 text-center border-0 card sidebar-alert bg-light">
                                        <div class="card-body">
                                            <img src="/default/assets/images/giftbox.png" alt="">
                                            <div class="mt-4">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script> © QTC LIMITED.
                    </div>
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Design & Develop by NAZ-TECH
                        </div>
                    </div>
                </div>
            </div>
