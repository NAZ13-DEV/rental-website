<x-hm-layout>
    ...
    <main class="mt-6 main about">
        <nav aria-label="breadcrumb" class="mt-10 breadcrumb-nav">
            <div class="container">
                <ol class="mt-5 breadcrumb">
        ...
        <div class="container">
            <div class="pt-3 bg-transparent page-header">
            ...
            <div class="pb-3 history-section">
                <div class="container">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="about-slider owl-carousel owl-theme dots-simple">
                                <div class="about-slider-item">
                                    <img class="owl-lazy" data-src="/default/assets/images/demoes/demo3/about/img-1.jpg"
                                        src="/default/assets/images/lazy.png" alt="About image description">
                                </div>
                                <div class="about-slider-item">
                                    <img class="owl-lazy" data-src="/default/assets/images/demoes/demo3/about/img-2.jpg"
                                        src="/default/assets/images/lazy.png" alt="About image description">
                                </div>
                                <div class="about-slider-item">
                                    <img class="owl-lazy" data-src="/default/assets/images/demoes/demo3/about/img-3.jpg"
                                        src="/default/assets/images/lazy.png" alt="About image description">
                                </div>
